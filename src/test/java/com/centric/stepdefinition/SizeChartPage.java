...
public class SizeChartPage extends Commonactions {
	...
	//	ca.click(driver.findElement(By.xpath("//span[@data-csi-automation='plugin-SizeChartRevision-TDS-refresh']//span[text()='refresh']")));
        ca.eleToBeClickable();
        Commonactions.isElementPresent(pp.getReset());
		ca.click(pp.getReset());
	...
	public void user_pass_the_Evaluation_as_Expected_value_refelcted_in_page() {
